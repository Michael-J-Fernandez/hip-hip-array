...
const students9 = students; // for challenge 9
...
fibonacciNumbers.unshift("Zero");
fibonacciNumbers.push("Twenty-One", "Thrity-Four");
...
// let myArray = []; 
// myArray.push(1, 2, 3, 4, 5)  // <-- not sure if something like this is what the instructions want me to do

let myArray = [1, 2, 3, 4, 5]

let i7 = 0;

while (i7 < myArray.length) {
  console.log(myArray[i7]);
  i7++;
} 
...
while (i8 < emptyArray.length) {

    console.log(emptyArray[i8]);
...
let studentsSlice = students.slice(3, 11);
let iSlice = 0;
let i11 = 0;

console.log("STUDENTS - Sliced Section: ");
while (iSlice < studentsSlice.length) {
  console.log(studentsSlice[iSlice]);
  iSlice++;
}

console.log("\n");
console.log("STUDENTS - Full List: ");
...
while (i14 < dinosaurs.length) {
  console.log(dinosaurs[i14]);
  i14++;
}
...
while (i15 < arrayConcat.length) {
  console.log(arrayConcat[i15]);
  i15++;
}
